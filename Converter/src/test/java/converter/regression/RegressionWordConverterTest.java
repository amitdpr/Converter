...
import converter.service.WordConverter;

/**
 * This is regression test class that generates all possibles numbers from 1 to
 * 3999. and verify its output and verify with regression-word.properties file
 * located in resources folder
 * (${root}/src/test/resources/regression-word.properties)
 * 
 * @author : amitkumarsingapore@gmail.com Date: Jan 19, 2015
 */
public class RegressionWordConverterTest {

	private static final Logger logger = LoggerService
			.getLogger(RegressionWordConverterTest.class);
	...
	/**
	 * Test method for
	 * {@link converter.core.service.WordConverter#convert(int)}.
	 * 
	...
	public final void convert() throws ConversionException {
		...
		SortedProperties properties = HelperService
				.getPropertyMap(Config.WordRegressionFile);
